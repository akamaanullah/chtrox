        ...
        <div class="file-card media-item" data-category="images">
            <div class="file-preview">
                ...
                <div class="file-actions-overlay">
                    <button class="action-circle" title="Preview"><i data-lucide="eye"></i></button>
                    <button class="action-circle" title="Download"><i data-lucide="download"></i></button>
                    <button class="action-circle delete" title="Delete"><i data-lucide="trash-2"></i></button>
                </div>
            </div>
